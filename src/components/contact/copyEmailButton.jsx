...
const CopyEmailButton = () => {
    ...
    const CopyEmail = () =>{
        setCopyState(true)
        navigator.clipboard.writeText('angel000hr@gmail.com')
        setTimeout(()=>{
            setCopyState(false)
        }, 2000)
    }
    ...
    return(
        <>
        {
            ...
            :
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6" onClick={()=>{CopyEmail()}}>
